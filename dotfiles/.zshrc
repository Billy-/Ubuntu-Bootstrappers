...
plugins=(alias-tips catimg chucknorris colored-man-pages colorize common-aliases docker docker-compose emoji git heroku httpie jira lol man react-native sudo tmux ubuntu yarn z zsh_reload zsh-syntax-highlighting)
